...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { buttontitle: @slider.buttontitle, subtitle: @slider.subtitle, title: @slider.title, url: @slider.url } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { buttontitle: @slider.buttontitle, subtitle: @slider.subtitle, title: @slider.title, url: @slider.url } }
