...
class AdoptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adoption" do
    assert_difference('Adoption.count') do
      post adoptions_url, params: { adoption: { adopter_id: @adoption.adopter_id, pet_id: @adoption.pet_id, status: @adoption.status, user_id: @adoption.user_id } }
    end
  ...
  test "should update adoption" do
    patch adoption_url(@adoption), params: { adoption: { adopter_id: @adoption.adopter_id, pet_id: @adoption.pet_id, status: @adoption.status, user_id: @adoption.user_id } }
