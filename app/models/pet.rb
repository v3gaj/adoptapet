class Pet < ApplicationRecord
  ...
  has_attached_file :cover, styles: { thumb: "700x172#", large: "1600x632#"}, convert_options: { thumb: "-quality 50", large: "-quality 50" }
  validates_attachment :cover, size: { in: 0..3.megabytes }
